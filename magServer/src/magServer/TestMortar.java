...
public class TestMortar {
	...
	@Test
	// Check if ID setting method is functional
	public void idTest() {
		mortar.setID("19");
	...
	@Test
	// Check if fuze setting method is functional
	...
	@Test
	// Check if GPS setting method is functional
	public void gpsTest() {
	...
	@Test
	// Check if elevation setting method is functional
	...
	@Test
	// test is stillThere setting method is functional
	...
	public void msgTest() {
		...
		assertEquals(mortar.makeMessage(), "iam 02,1,DC567856785678,98765");
	}

	@Test
	public void msgTestFail() {
		mortar.updateSelf("02", "15", "DC567856785678", "98765");
		assertEquals(mortar.makeMessage(), "Failure");
	}
